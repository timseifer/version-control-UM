...
extern void addition_test(Seq_T instructions);
extern void last_test(Seq_T instructions);
...
static struct test_info {
        ...
        { "add", NULL, "", addition_test },
        { "input-output", NULL, "", last_test },
        { "mult", NULL, "", multiplication_test },
        { "divis", NULL, "", Division_test },
        {"bnand", NULL, "", bit_nand_test},
        {"condmove", NULL, "", cond_move},
        {"map-unmap", NULL, "", mapnunmapTest},
        {"seg-load", NULL, "", segmented_load_unload},
};
